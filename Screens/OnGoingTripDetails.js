...
export default function OnGoingTripDetails({ navigation }) {
    return (
        <View style={styles.container}>

            {/* HEADER */}
            <AppHeader title="OnGoing Trip" navigation={navigation} />
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <Card>
                    ...
                    <View style={styles.rowBetweencancel}>
                        <TouchableOpacity style={styles.acceptBtn}>
                ...
                <Card>
                    ...
                    <View style={styles.dateTimeRow}>
                        <View style={styles.dateTimeCol}>
                            ...
                            <Text>20 Nov 2025 10:00 AM</Text>
                        </View>

                        <View style={styles.dateTimeCol}>
                            <Text style={styles.label}>Trip Reach Time</Text>
                            <Text>20 Nov 2025 03:00 PM</Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.dateTimeRow}>
                        <View style={styles.dateTimeCol}>
                            <Text style={styles.label}>Distance Cover</Text>
                            <Text>40 Km</Text>
                        </View>
